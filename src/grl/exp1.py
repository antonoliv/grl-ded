...
sac(test_path + m_sac_path, m_train_env, m_val_env, train_ep, eval_ep, "MultiInputPolicy", SEED)
sac(test_path + b_sac_path, b_train_env, b_val_env, train_ep, eval_ep, "MlpPolicy", SEED)
sac(test_path + mt_sac_path, mt_train_env, mt_val_env, train_ep, eval_ep, "MultiInputPolicy", SEED)
sac(test_path + mdt_sac_path, mdt_train_env, mdt_val_env, train_ep, eval_ep, "MultiInputPolicy", SEED)